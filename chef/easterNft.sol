...
contract PancakeProfile is AccessControl, ERC721Holder {
   ...
   * Callable only by owner admins.
   */
  function addTeam(string calldata _teamName, string calldata _teamDescription)
    external
    onlyOwner
  {
...
// File: contracts/BunnySpecialV2.sol
...
contract BunnySpecialV2 is Ownable {
  ...
  function mintNFT() external {
    ...
    (userId, , userTeamId, , , isUserActive) = pancakeProfile.getUserProfile(
      senderAddress
    );
